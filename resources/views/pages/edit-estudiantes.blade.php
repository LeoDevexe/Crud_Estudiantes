                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Editar estudiante</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{$estudiante->cedula}}" name="cedula" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" value="{{$estudiante->email}}" name="email">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{$estudiante->nombres}}" name="nombres">
                                    @error('nombres')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{$estudiante->apellidos}}" name="apellidos">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{$estudiante->edad}}" name="edad">
